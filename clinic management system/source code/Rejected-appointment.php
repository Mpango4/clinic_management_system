...
<tbody>
  <?php
    $sql ="SELECT * FROM appointment WHERE status='Rejected' and patientid='$_SESSION[patientid]'  and delete_status='1'";
        ...
        <td>&nbsp;$rsdept[departmentname]</td>
         <td>&nbsp;$rsdoc[name]</td>
          ...
          if($rs['status'] == "Rejected")
          {
            ...
            echo "<a href='appointment.php?editid=$rs[appointmentid]' class='btn btn-xs btn-primary'>Try Again</a>";
          }
          else
          {
            echo "<a href='patientreport.php?patientid=$rs[patientid]&appointmentid=$rs[appointmentid]' class='btn btn-xs btn-primary'>Try Again </a>";
          }
          echo "</td></tr>";
        }
    ?>
