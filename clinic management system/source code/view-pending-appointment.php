...
if(isset($_GET['delid']))
{
  $sql ="UPDATE appointment SET status='Rejected' , delete_status='1'  WHERE appointmentid='$_GET[delid]'";
...
?>
         <div class="popup popup--icon -success js_success-popup popup--visible">
          ...
          <div class="popup__content">
            ...
            <p>Appointment record canceled successfully.</p>
            <p>
...
<tbody>
<?php
        $sql ="SELECT * FROM appointment WHERE (status='Pending')and professional_id = '$_SESSION[professional_id]' and delete_status = '0'";
        ...
        while($rs = mysqli_fetch_array($qsql))
        {
          ...
          if($rs['status'] != "Approved")
          {
            ...
            echo "  <a href='view-pending-appointment.php?id=$rs[appointmentid]' class='btn btn-xs btn-danger'>Cancel</a>";
          }
          else
          {
