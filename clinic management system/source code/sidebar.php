...
<div class="pcoded-navigatio-lavel " style="background-color: aliceblue; font-weight:bolder; ">MLELE HOSPITAL</div>
...
<li class="pcoded-hasmenu">
    ...
    <?php if(($_SESSION['user'] == 'admin') || ($_SESSION['user'] == 'doctor')) { ?>
        ...
        <li class="">
            <a href="view-pending-appointments.php">
                <span class="pcoded-mtext">View Pending Appointments</span>
            </a>
        </li>
        <li class="">
            <a href="view-appointment-approved.php">
    ...
    <?php if($_SESSION['user'] == 'patient') { ?>
        ...
        <li class="">
            <a href="Rejected-appointment.php">
                <span class="pcoded-mtext">Rejected appointments</span>
            </a>
        </li>
    <?php } ?>
    </ul>
...
<li class="pcoded-hasmenu">
    <a href="javascript:void(0)">
        ...
        <span class="pcoded-mtext">Professionals</span>
    </a>
    <ul class="pcoded-submenu">
...
<li class="pcoded-hasmenu">
    <a href="javascript:void(0)">
        <span class="pcoded-micon"><i class="feather icon-home"></i></span>
        <span class="pcoded-mtext">Wards</span>
    </a>
    <ul class="pcoded-submenu">
    <?php if($_SESSION['user'] == 'admin'){ ?>
        <li class="">
            <a href="manage_wards.php">
                <span class="pcoded-mtext">New ward</span>
            </a>
        </li>
        <li class="">
            <a href="add_new_bed.php">
                <span class="pcoded-mtext">Add bed room</span>
            </a>
        </li>
    <?php }?>
        <li class="">
            <a href="view-wards.php">
                <span class="pcoded-mtext">View  ward</span>
            </a>
        </li>
        <li class="">
            <a href="view-beds.php">
                <span class="pcoded-mtext">View  bed room</span>
            </a>
        </li>
...
<li class="pcoded-hasmenu">
    ...
    <ul class="pcoded-submenu">
        ...
        <li class="">
            <a href="view_reminders.php">
                <span class="pcoded-mtext">view reminders</span>
            </a>
        </li>
    </ul>
</li>
...
<li class="pcoded-hasmenu">
    ...
    <ul class="pcoded-submenu">
        ...
        <li class="">
            <a href="treatment_form.php">
                <span class="pcoded-mtext"> add treatment</span>
            </a>
        </li>
    </ul>
</li>
...
<li class="pcoded-hasmenu">
    ...
    <?php if($_SESSION['user'] == 'admin') { ?>
        <li class="">
            <a href="schedule.php">
                <span class="pcoded-mtext">create schedule</span>
            </a>
        </li>
    <?php } ?>
    <?php if($_SESSION['user'] == 'admin') { ?>
...
<li class="pcoded-hasmenu">
    ...
    <ul class="pcoded-submenu">
        ...
        <li class="">
            <a href="Setting.php">
                <span class="pcoded-mtext">Hospital settings</span>
            </a>
        </li>
        ...
        <!-- <li class="">
            <a href="manage_website.php">
                <span class="pcoded-mtext">Manage website</span>
            </a>
        </li> -->
        <!-- <li class="">
